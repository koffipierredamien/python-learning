...
| **3. Identité** — 5 min puis libre | Le questionnaire ([A1 §4](../annexes/A1-diagnostic-et-passeport.md)) | En autonomie ; ceux qui finissent prennent **une énigme d'avance** de la station 2 |
...
| ✅ Vérifier un poste avant la séance | [`demo/verifier_le_jeu.py`](../../demo/verifier_le_jeu.py) |
| 💾 Contenu de la clé USB | [`cle-usb/`](../../cle-usb/README.md) |
