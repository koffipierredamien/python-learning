...
taches = [
    ...
    ("J-7", "Lancer un programme sur CHAQUE poste pour verifier (lancer 4-outils/verifier_un_poste.py)", "Les deux"),
    ("J-7", "Creer le dossier GEEKS sur le Bureau de chaque poste (4-outils/installer_dossier_geeks.py)", "Mecanicien"),
    ("J-7", "Regler la police de Thonny en taille 18 sur tous les postes et sur la machine de projection", "Mecanicien"),
    ("J-7", "Preparer la cle USB maitresse (4-outils/preparer_cle_usb.py)", "Capitaine"),
    ...
    ("J-1", "Imprimer 10 - Grille d'observation + corriges (2 ex., A4 paysage, 3 pages)", "Capitaine"),
    ...
    ("J-1", "Imprimer MON-SCRIPT d'animation (14 pages A4, agrafe)", "Capitaine"),
