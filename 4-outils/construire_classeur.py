...
Pour un usage normal, travaillez directement dans Google Sheets.
   Utilisation :  python 4-outils/construire_classeur.py
...
lignes = [
    ...
    ("LE DECLENCHEUR A SURVEILLER", "Dans 04_Suivi-seances, la colonne ALERTE passe a OUI des qu'un eleve cumule deux seances de suite "
     "sans production. Cet eleve entre sur la LISTE DES 10 MINUTES : l'enseignant lui consacre 10 minutes en tete-a-tete "
...
for i, v in enumerate(["05/09/2026", "S01", "KOUASSI Awa", "Difficulte",
                       ...
                       "Enseignant", "12/09/2026", "A faire"], start=1):
...
# =====================================================================  09_Checklist-S01
taches = [
    ("J-7", "Coder le jeu XO termine et le tester sur la machine de demo (c'est le WOW : sans lui, la seance perd son moteur)", "Enseignant"),
    ("J-7", "Installer Python + Thonny sur TOUTES les machines, meme version", "Les deux classes"),
    ("J-7", "Lancer un programme sur CHAQUE poste pour verifier (lancer 4-outils/verifier_un_poste.py)", "Les deux classes"),
    ("J-7", "Creer le dossier GEEKS sur le Bureau de chaque poste (4-outils/installer_dossier_geeks.py)", "Enseignant"),
    ("J-7", "Regler la police de Thonny en taille 18 sur tous les postes et sur la machine de projection", "Enseignant"),
    ("J-7", "Preparer la cle USB maitresse (4-outils/preparer_cle_usb.py)", "Enseignant"),
    ("J-7", "Verifier le videoprojecteur AVEC le cable et la machine du jour", "Enseignant"),
    ("J-7", "Reserver la salle 30 min avant (Sas Permis Machine)", "Les deux classes"),
    ("J-1", "Imprimer 01 - Cartes de signalisation (1 page par binome, papier epais)", "Enseignant"),
    ("J-1", "Imprimer 02 - Affiche 3 avant moi (A3)", "Enseignant"),
    ("J-1", "Imprimer 03 - Affiche Contrat des Geeks (A3)", "Enseignant"),
    ("J-1", "Imprimer 04 - Affiche Dictionnaire des erreurs (A3)", "Enseignant"),
    ("J-1", "Imprimer 05 - Mur de Mission (A3 paysage)", "Enseignant"),
    ("J-1", "Imprimer 06 - Fiche memo eleve (1 par binome)", "Enseignant"),
    ("J-1", "Imprimer 07 - Cartes-missions station 1 (6 ex.)", "Enseignant"),
    ("J-1", "Imprimer 08 - Enigmes station 2 (6 ex., recto-verso)", "Enseignant"),
    ("J-1", "Imprimer 09 - Ma fiche de Geek (1 par eleve)", "Enseignant"),
    ("J-1", "Imprimer 10 - Grille d'observation + corriges (2 ex., A4 paysage, 3 pages)", "Enseignant"),
    ("J-1", "Imprimer 11 - Etiquettes prenoms (3 pages) et les decouper", "Enseignant"),
    ("J-1", "Imprimer 12 - Affiche Aider sans faire a la place (2 ex.)", "Enseignant"),
    ("J-1", "Imprimer 13 - Cartes des pistes Rouge et Noire (1 par binome)", "Enseignant"),
    ("J-1", "Imprimer MON-SCRIPT d'animation (14 pages A4, agrafe)", "Enseignant"),
    ("J-1", "Acheter / preparer : post-it (2 par eleve), feutres, gommettes-badges, ruban adhesif", "Enseignant"),
    ("J-1", "Preparer la boite a post-it et le minuteur visible", "Enseignant"),
    ("J-1", "Relire la fiche de seance en entier, a deux", "Les deux classes"),
    ("Jour J", "Arriver 30 min avant. Machines allumees, Thonny ouvert, dossier GEEKS visible", "Les deux classes"),
    ("Jour J", "Lancer le jeu fini et le REDUIRE (ne jamais chercher le fichier devant la classe)", "Enseignant"),
    ("Jour J", "Machine de reserve allumee au fond de la salle", "Enseignant"),
    ("Jour J", "Afficher les 4 affiches + le Mur de Mission", "Enseignant"),
    ("Jour J", "Poser sur chaque poste : fiche memo, 4 cartes, carte des pistes, 2 post-it par eleve", "Les deux classes"),
    ("Jour J", "Verifier que mon_xo/jeu.py est bien present et s'ouvre sur chaque poste", "Enseignant"),
    ("Jour J", "Un message au collegue de l'autre classe : tout est pret des deux cotes ?", "Les deux classes"),
    ("Jour J", "Choisir le signal de silence et s'accorder dessus", "Les deux classes"),
    ("Pendant", "A 104 min : verifier qu'AUCUN ecran n'est reste vide. Priorite absolue.", "Les deux classes"),
    ("Pendant", "Sauvegarder le travail de chaque binome sur la cle (4-SAUVEGARDES-ELEVES/S01)", "Enseignant"),
    ("Apres", "Finaliser le code officiel S01 et le copier sur la cle", "Enseignant"),
    ("Apres", "Remplir 03_Presence et 04_Suivi-seances", "Enseignant"),
    ("Apres", "Saisir le diagnostic dans 02_Diagnostic", "Enseignant"),
    ("Apres", "Trier les post-it en 2 tas et noter la difficulte la plus citee", "Les deux classes"),
    ("Apres", "Etablir la liste des 10 minutes pour la seance 2", "Les deux classes"),
    ("Apres", "Envoyer le message aux familles", "Enseignant"),
    ("Apres", "Repondre aux 3 questions de la revue (onglet 10)", "Les deux classes"),
    ("Apres", "Appeler le collegue de l'autre classe : 10 minutes de debrief", "Les deux classes"),
]
...
cols = ["Seance", "Date", "Enseignant", "Enseignant", "Presents", "Q1 - Qui a decroche, et qu'est-ce qu'on fait samedi ?",
...
materiel = [
    ...
    ("Impression", "Grille d'observation + corriges", 2, "PAGES 2-3 = CORRIGES, ne pas laisser trainer"),
    ...
    ("Impression", "MON-SCRIPT d'animation", 1, "14 pages, agrafe"),
    ...
    ("Achat", "Cle USB", 1, "Contenu : voir 4-outils/LISEZ-MOI.md"),
    ...
    ("Logiciel", "Dossier GEEKS cree sur chaque Bureau", 0, "Via 4-outils/installer_dossier_geeks.py"),
]
...
wb.save(os.path.join(racine, "3-suivi", "classeur-de-suivi.xlsx"))
