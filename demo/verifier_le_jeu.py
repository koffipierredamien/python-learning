...
# ------------------------------------------------------------ 2. la logique
try:
    from xo_complet import (nouveau_plateau, gagnant, cases_libres,
                            partie_finie, coup_ordinateur, ALIGNEMENTS)
except ImportError as erreur:
    print("[ERREUR] Impossible de lire xo_complet.py : %s" % erreur)
    print("         Verifiez que verifier_le_jeu.py et xo_complet.py sont bien")
...
print("=" * 62)
if problemes == 0:
    print("  TOUT EST PRET.  Lancez maintenant xo_complet.py pour tester la demo.")
else:
