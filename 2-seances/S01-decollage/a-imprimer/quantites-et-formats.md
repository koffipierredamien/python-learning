...
```
2-seances/S01-decollage/
├── a-imprimer/     ←  VOUS ÊTES ICI. Ouvrez un PDF, imprimez. Rien d'autre à faire.
└── sources/           les fichiers modifiables, seulement pour corriger un texte
```
...
- **Pour vos responsables :** ce n'est pas un PDF, c'est un **document Word modifiable** — [`../a-envoyer/deroule-seance-1.docx`](../a-envoyer/deroule-seance-1.docx). Ajoutez-y votre en-tête, puis envoyez-le par mail.
...
| 13 | `13-cartes-pistes.pdf` | A4 **couleur** | 1 | **inutile en séance 1** — les 3 pistes démarrent en séance 2 | Élèves |
...
|---|---|
| A4 noir et blanc | ≈ 70 |
| A4 couleur | ≈ 10 (document 01 — les cartes de signalisation) |
| A3 couleur | 4 |

> 💡 **Les 4 cartes de signalisation (document 01) servent aussi de cartes de réponse au Kahoot** si internet est indisponible : réponse 1 = 🔴 · 2 = 🔵 · 3 = 🟠 · 4 = 🟢.
>
...
- Une clé USB (voir [`4-outils/LISEZ-MOI.md`](../../../4-outils/LISEZ-MOI.md))

---

## Modifier un document

Les fichiers du dossier voisin `sources/` sont les originaux. Ouvrez-en un avec un éditeur de texte (le Bloc-notes suffit), corrigez le texte
entre les balises, enregistrez. Puis, pour refabriquer le PDF : ouvrez le fichier dans Chrome → `Ctrl+P` →
destination **« Enregistrer au format PDF »** → enregistrez dans `a-imprimer/` sous le même nom.
