...
|---|---|---|
| **[S01 — Le Décollage](S01-decollage/fiche-de-seance.md)** · samedi 12 septembre 2026 | *(faite)* La théorie et les missions de décollage | Pourquoi et comment on code · l'algorithme |
| **[S02 — Premier contact machine](S02-premier-contact/fiche-de-seance.md)** · samedi 19 septembre 2026 | L'écran d'accueil du jeu XO | `print()` · les guillemets · lire une erreur |
| S03 à S22 | *à venir* | |
...
│     seance-2-projection.pptx      le diaporama de la séance (24 diapos)
│     prompt-pour-gemini.md         pour refaire le diaporama en plus beau
