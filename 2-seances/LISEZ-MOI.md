...
|---|---|---|
| **[S01 — Le Décollage](S01-decollage/fiche-de-seance.md)** · samedi 12 septembre 2026 | L'écran d'accueil du jeu XO | `print()` |
| S02 à S22 | *à venir* | |
...
4. **Le jour J** — animer avec `00-MON-SCRIPT-animation.pdf` à la main.
5. **Le soir** — remplir le [classeur de suivi](../3-suivi/LISEZ-MOI.md) et répondre aux 3 questions de la revue.
